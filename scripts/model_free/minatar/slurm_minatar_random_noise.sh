...
echo "sbatch $SLURM_SUBMIT_DIR/slurm_minatar_random_noise.sh $name $task_name $num_envs $loss_functions $checkpoint_dir" > $checkpoint_dir/restart.sh
